  ...
  return (
   <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
      ...
      <form className='flex items-center justify-between max-w-2xl w-full md:h-13 h-12'>
        <input className='border border-gray-300 rounded-md h-full border-r-0 outline-none w-full rounded-r-one px-3 text-gray-500' type='text' placeholder='Enter your enail id' required/>
